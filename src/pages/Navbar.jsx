        ...
        <>
            <div className='bg-gray-300 md:flex md:flex-row justify-between items-center w-full h-20 text-white py-4 md:px-16 z-50'>
                <div className="flex justify-between md:justify-start px-8 items-center md:gap-12">
                    ...
                    <input type="text" placeholder="search" className="rounded-full w-40 md:w-[500px] h-10 text-black px-6 border-2 border-black focus focus:outline-none bg-transaprent"></input>
                    <div onClick={() => setOpen(!open)} className="ml-4 md:hidden cursor-pointer"><FaBars /></div>
                </div>
                <div className={`absolute md:static md:z-auto z-[-1] transition-all duration-500 ease-in md:flex flex-col md:flex-row w-full h-96 md:h-20 md:w-[300px] bg-gray-300 ${open ? 'top-20' : 'mt-[-490px]'}`}>
