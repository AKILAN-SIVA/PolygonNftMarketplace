                    ...
                    <div className='grid justify-start items-start h-fit gap-8 mt-8'>
                        ...
                        <div className='bg-gray-900 border-2 border-gray-700 w-full h-48 rounded-xl'>
                            <div className='grid justify-start items-center gap-4 p-8'>
                                ...
                                {
                                    (state.owner).toLowerCase() == walletAddress.toLowerCase() ? <button className='text-black bg-white rounded-xl w-full h-12 font-bold' >List your NFT</button> : <button className='text-black bg-white rounded-xl w-full h-12 font-bold' onClick={BuyNFT}>Buy NFT</button>
                                }
                            </div>
                        </div>
