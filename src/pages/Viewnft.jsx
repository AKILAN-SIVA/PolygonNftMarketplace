            ...
            <div className="flex justify-start gap-16">
              ...
              <div className="grid justify-start items-start h-fit gap-8 mt-8">
                <div className="flex justify-between items-center gap-4">
                  ...
                  <div>
                    <button
                      className="flex justify-center items-center bg-white h-12 w-48 text-black text-xl rounded-2xl"
                ...
                <div className="border-2 border-gray-800 w-fit h-fit rounded-xl">
                  <div className="grid justify-start items-center gap-4 p-8">
                    ...
                    {state.data.owner.toLowerCase() ==
                    walletAddress.toLowerCase() ? (
                      state.data.bidNFT == false &&
                      state.data.listNFT == false ? (
                        <>
                          <button
                            className="text-black bg-white rounded-xl w-full h-12 font-bold"
                        ...
                        <>
                          {state.data.listNFT == true ? (
                            <>
                              <button className="text-black bg-white rounded-xl w-full h-12 font-bold">
                                You Can't list the NFT Again{" "}
                              </button>
                            </>
                          ) : (
                            <>
                              <button className="text-black bg-white rounded-xl w-full h-12 font-bold">
                                You Can't Bid the NFT Again{" "}
                              </button>
                            </>
                          )}
                        </>
                      ...
                      <>
                        <div className="flex justify-center items-center gap-4 text-black bg-white rounded-xl w-full h-12 font-bold cursor-pointer">
                          <button className="" onClick={BuyNFT}>
                            Buy NFT{" "}
                          </button>
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray-300 outline-none focus:outline-none">
                              ...
                              <div className="relative p-6 flex-auto">
                                <input
                                  ...
                                  className="bg-transparent w-[600px] h-12 text-black rounded-lg border-2 border-black p-4"
                                  placeholder="Enter Base price for Bidding"
                                  value={bidPrice}
                                />
                              </div>
                              {/* <div className="relative p-6 flex-auto">
                              ...
                              <div className="relative p-6 flex-auto">
                                <input
                                  ...
                                  className="bg-transparent w-[600px] h-12 text-black rounded-lg border-2 border-black p-4"
                                  placeholder="October 13, 2023 13:10:00"
                                  value={timeInStr}
                                />
                              </div>
                              {/*footer*/}
