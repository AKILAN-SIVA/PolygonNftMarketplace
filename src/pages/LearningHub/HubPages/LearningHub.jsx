...
import AboutNft from "../HubAssets/AboutNft.png"
import Wallet from "../HubAssets/Wallet.png"
import ListNft from "../HubAssets/ListNft.png"
import MintNft from "../HubAssets/MintNft.png"
import BidNft from "../HubAssets/BidNft.png"
        ...
        <div className='grid items-center gap-28 pt-12 font-serif'>
            <div className='flex justify-center items-start w-full'>
                ...
                <div className='grid justify-center items-center w-1/2 mt-20 gap-12'>
                    ...
                    <div className='flex justify-center w-full'>
                        <button className="flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-widest text-xl text-black font-semibold  w-56 h-14 rounded-3xl" onClick={() => window.location.replace("/learningHub/NftInfo")}>Learn More <FiArrowUpRight size={28} /></button>
                    </div>
                </div>
            </div>
            <div className='flex justify-around items-start w-full'>
                <div className='grid justify-center items-center w-1/2 mt-20 gap-12'>
                    ...
                    <div className='flex justify-center w-full'>
                        <button className="flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-widest text-xl text-black font-semibold  w-56 h-14 rounded-3xl" onClick={() => window.location.replace("/learningHub/MetaMaskInfo")}>Learn More <FiArrowUpRight size={28} /></button>
                    </div>
                </div>
            ...
            <div className='flex justify-around items-start w-full'>
                ...
                <div className='grid justify-center items-center w-1/2 mt-20 gap-12'>
                    <h1 className='flex justify-center text-5xl font-bold tracking-widest'>Minting an NFT ?</h1>
                    <p className='text-center text-xl tracking-wider leading-loose'>
                    ...
                    <div className='flex justify-center w-full'>
                        <button className="flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-widest text-xl text-black font-semibold  w-56 h-14 rounded-3xl" onClick={() => window.location.replace("/learningHub/MintInfo")}>Learn More <FiArrowUpRight size={28} /></button>
                    </div>
                </div>
            </div>
            <div className='flex justify-around items-start w-full'>
                <div className='grid justify-center items-center w-1/2 mt-20 gap-12'>
                    <h1 className='flex justify-center text-5xl font-bold tracking-widest'>Listing an NFT ?</h1>
                    <p className='text-center text-xl tracking-wider leading-loose'>
                        ...
                        NFT, facilitating the transfer of ownership of digital
                    </p>
                    <div className='flex justify-center w-full'>
                        <button className="flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-widest text-xl text-black font-semibold  w-56 h-14 rounded-3xl" onClick={() => window.location.replace("/learningHub/ListingInfo")}>Learn More <FiArrowUpRight size={28} /></button>
                    </div>
                </div>
            ...
            <div className='flex justify-around items-start w-full'>
                ...
                <div className='grid justify-center items-center w-1/2 mt-20 gap-12'>
                    <h1 className='flex justify-center text-5xl font-bold tracking-widest'>Bidding an NFT ?</h1>
                    <p className='text-center text-xl tracking-wider leading-loose'>
                    ...
                    <div className='flex justify-center w-full'>
                        <button className="flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-widest text-xl text-black font-semibold  w-56 h-14 rounded-3xl" onClick={() => window.location.replace("/learningHub/BiddingInfo")}>Learn More <FiArrowUpRight size={28} /></button>
                    </div>
                </div>
            </div>
        </div>
