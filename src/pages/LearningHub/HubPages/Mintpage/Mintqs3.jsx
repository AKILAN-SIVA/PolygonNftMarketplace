    ...
    return (
        <div className='w-full h-fit'>
            <div className='grid justify-start items-center gap-6'>
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Decentralized Content Storage:</span> When creating an NFT, the digital
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Immutable Links:</span> IPFS generates a unique cryptographic hash for each
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Reduced Gas Fees:</span>On blockchain networks like Ethereum, where most
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Scalability:</span> IPFS&#39;s distributed nature enables easy scaling of content
