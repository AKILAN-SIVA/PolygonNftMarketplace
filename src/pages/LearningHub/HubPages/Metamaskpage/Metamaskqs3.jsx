    ...
    return (
        <div className='w-full h-fit'>
            <div className='grid justify-start items-center gap-6'>
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Backup Your Seed Phrase:</span> MetaMask will generate a 12-word seed phrase.
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Confirm Your Seed Phrase:</span> To ensure you&#39;ve correctly written down your seed
                    phrase, MetaMask will ask you to confirm it by selecting the words in the correct
                    order.
                </p>
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Wallet Ready:</span> Congratulations! Your MetaMask wallet is now set up and secure.
                    You can now use it to store, send, and receive Ethereum and other compatible
                    tokens.
                </p>
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Add Funds:</span> To add funds to your wallet, you can purchase Ethereum from a
                ...
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Explore DApps:</span> MetaMask allows you to interact with decentralized applications
                    (DApps). Visit a DApp you&#39;re interested in, and MetaMask will automatically
                    connect your wallet.
                </p>
                <p className='text-lg tracking-wider text-justify px-12'>
                    <span className='text-2xl font-semibold'>Security Tips:</span> Remember to keep your password and seed phrases safe and
